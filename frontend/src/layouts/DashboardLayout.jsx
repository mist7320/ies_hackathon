...
const DashboardLayout = ({ children, activeRoute = 'dashboard', onNavigate }) => {
          ...
          <div className="p-3 bg-slate-800/40 rounded-xl border border-slate-700/40 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="truncate">
                <p className="text-xs font-semibold text-slate-200 truncate">Jessica Danforth</p>
                <p className="text-[11px] text-slate-400 truncate">Head of Legal Operations</p>
              </div>
            </div>
